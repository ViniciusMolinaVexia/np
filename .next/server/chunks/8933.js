...
/* harmony import */ var _service_storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6008);
/* harmony import */ var _service_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1659);
...
class Footer extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
    ...
    _storage = new _service_storage__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z();
    async componentDidMount() {
        this.setState({
    ...
    openLinkTarget = async (target, event)=>{
        ...
        new _service_util__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z().goToUrl([
            "fale-conosco#" + target
        ], "_self", false, event);
    };
    openFornecedor = ()=>{
...
const Meta = (props)=>{
    ...
    const images = props.images || [
        {
            url: _Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_3__/* .URL_DOMAIN */ .V3 + "/static/images/alphaville.jpg",
            type: "image/jpeg",
            width: "1200",
            height: "489",
            alt: "Alphaville"
    ...
    function canonicalModel() {
        ...
        if (props.homeContent?.statusObra?.id === "0" && !props.success) {
            url = `${_Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_3__/* .URL_DOMAIN */ .V3}/teaser/${props.homeContent.slug}`;
        } else if (props.success) {
            url = `${_Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_3__/* .URL_DOMAIN */ .V3}/teaser/${props.homeContent.slug}/agradecimento`;
        } else {
            url = `${_Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_3__/* .URL_DOMAIN */ .V3}/`;
        }
        return url;
    }
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((next_head__WEBPACK_IMPORTED_MODULE_1___default()), {
        children: [
            ...
            props.showNoIndex && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                name: "robots",
                content: "noindex"
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                ...
                content: _Envirioment_Envirioment__WEBPACK_IMPORTED_MODULE_3__/* .SITE_NAME */ .px
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                property: "og:url",
                content: `${props.url}`
            ...
            props.css && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("link", {
                rel: "stylesheet",
                href: `${props.css}`
            }),
            images.map((img, idx)=>{
            ...
            props.images != null && props.images.length > 0 && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("meta", {
                name: "twitter:image",
                content: `${props.images[0].url}`
            }),
            props.js && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("script", {
