...
/* harmony import */ var _share_layouts_layout_main__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3001);
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_share_layouts_layout_main__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z, {
        ...
        children: [
            !isMobile && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_share_components_backButton__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
                link: `residencial/${homeContent.slug}`,
                colors: homeContent.displayColors
            }),
...
ResidenciaAgradecimento.getInitialProps = async ({ req , query  })=>{
    ...
    const currentUrl = isServer ? `http://${req.headers.host}${req.url}` : window.location.href;
    const partesDaUrl = currentUrl.split("/");
    const indiceEmpreendimento = partesDaUrl[4];
    const empreendimento = await enterpriseService.getEnterpriseBySlugTitle(indiceEmpreendimento, true);
    return {
...
var __webpack_exports__ = __webpack_require__.X(0, [2952,1270,1664,1890,1790,5176,1659,8933,3001,5129,2750,3817], () => (__webpack_exec__(772)));
